                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-8 m-auto">
                            ...
                            <div class="section-title with-sep title-style-center_text">
                                ...
                                <div class="title-desc">Nuestro excelente equipo está listo para ser parte de su equipo
                                    para
                                    ...
                                    <div class="featured-thumbnail">
                                        <a href="{{route('web.service.index',$service->slug)}}">
                                            @if(!empty($service->image_source))
                                                <img class="img-fluid"
                                                     src="{{url('storage/services/'. $service->image_source)}}"
                                                     alt="image">
                                            @else
                                                <img class="img-fluid" src="{{url('images/services-01.jpg')}}"
                                                     alt="image">
                                            @endif
                                        </a>
                        ...
                        <div class="col-lg-12">
                            <div class="mt-50 res-991-mt-30 text-center">
                                <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-rounded ttm-btn-style-fill ttm-icon-btn-left ttm-btn-color-dark"
                                   href="{{route('web.contact-us.index')}}"><i
                                        class="flaticon-email"></i>Contáctanos</a>
                            </div>
                        </div>
                    </div>
                </div>
